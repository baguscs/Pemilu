                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form method="post" action="{{ route('ganti_camat', $calon->id) }}" enctype="multipart/form-data">
                            	@csrf
                            <div class="row clearfix">
                                <div class="col-sm-12">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    ...
                                    <a target="_blank" href="{{ asset('images/camat/'. $calon->foto) }}" data-sub-html="{{$calon->nama}}">
                                <img class="img-responsive thumbnail" width="20%" src="{{ asset('images/camat/'. $calon->foto) }}">
                                 </a>
                                    <div class="form-group">
                                        <div class="form-line">
