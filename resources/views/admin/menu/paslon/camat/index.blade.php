        ...
        <div class="container-fluid">
            <!-- Widgets -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                                <p style="font-size: 19px">DATA CALON CAMAT
                                    @if (auth::user()->pengguna->role_id == 1)
                                        <a href="{{ route('tambah_camat') }}" title="Tambah Calon" class="btn btn-success" style="float: right;"><i class="material-icons">
                            add</i></a>
                                    @endif
                             ...
                             <div class="row clearfix">
                                <div class="col-sm-12">
                                    @foreach ($status as $p)
                                    <form method="post" action="{{ route('status_camat', $p->id) }}">
                                @csrf
                                    <div class="demo-radio-button">
                                        <h2 style="margin-bottom: 10px" class="card-inside-title">Status Pendaftaran Calon Camat</h2>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>NIP</th>
                                            <th width="25px">Umur</th>
                                            <th style="width: 100px">Pengalaman</th>
                                            <th>Status</th>
                                            <th>Opsi</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="defaultModalLabel">Input Nomor Urut Calon Camat</h4>
                                                            </div>
                                                            <div class="modal-body">
                                                                <div class="media">
                                                                    <div class="media-left media-middle">
                                                                        <a target="_blank" href="{{ asset('images/camat/'. $p->foto) }}">
                                                                            <img class="media-object" src="{{ asset('images/camat/'. $p->foto) }}" width="100" height="80">
                                                                        </a>
                                                                    </div>
                                                                    <div class="media-body">
                                                                        <h4 style="margin-bottom: 20px" class="media-heading">{{$p->nama}}</h4>
                                                                        <form action="{{ route('norut_camat', $p->id) }}" method="post">
                                                                            @csrf
                                                                            <div class="row clearfix">
                                                                            <div class="col-sm-12">
                                            ...
                                            <td>
                                                @if ($p->status == Null)
                                                     <button type="button" class="btn btn-warning waves-effect" data-trigger="focus" data-container="body" data-toggle="popover"
                                            ...
                                            <td>
                                                 ...
                                                 @if ($p->status == "ya" || $p->status == "tidak" || auth::user()->pengguna->role_id == 2)
                                                  ...
                                                  <div class="modal fade" id="largeModal{{$loop->iteration}}" tabindex="-1" role="dialog">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <h2 class="card-inside-title">Foto Calon</h2>
                                                               <a target="_blank" href="{{ asset('images/camat/'. $p->foto) }}" data-sub-html="{{$p->nama}}">
                                                        <img class="img-responsive thumbnail" width="30%" src="{{ asset('images/camat/'. $p->foto) }}">
                                                         </a>
                                                        </div>
                                                        <div class="col-sm-6">
                                                    ...
                                                    @endphp
                                                    <a href="{{ route('verif_camat', $id) }}" style="width: 90px;height: 35px" type="button" class="btn bg-blue waves-effect waves-float"><i class="material-icons">verified_user</i></a>
                                                    ...
                                                    $parameter = [
                                                         ...
                                                         $id = Crypt::encrypt($parameter);
                                                    @endphp
                                                      <a href="{{ route('edit_camat', $id) }}" title="Edit Camat" class="btn btn-primary" ><i class="material-icons">create</i></a>


                                                     <button type="button" data-color="red" class="btn bg-red waves-effect" data-toggle="modal" data-target="#defaultModal{{$loop->iteration}}" title="Hapus"><i class="material-icons">delete</i></button>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title" id="defaultModalLabel">Hapus Calon Camat</h4>

                                                            </div>
                                                            <div class="modal-body">
                                                               Anda Yakin ingin menghapus Calon Camat {{$p->nama}} ?
                                                            </div>
                                                            <div class="modal-footer">
                                                                <form action="{{ route('hapus_camat', $p->id) }}" method="post">
                                                                @csrf
