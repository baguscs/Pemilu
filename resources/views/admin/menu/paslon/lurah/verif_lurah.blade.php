        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>VERIFIKASI DATA CALON LURAH</h2>
                        </div>
                        ...
                        <div class="body">
                            ...
                            <form method="post" action="{{ route('lurah_verified', $verif->id) }}" enctype="multipart/form-data">
                            	@csrf
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <center>
                                    <h2 class="card-inside-title">Pas Foto Calon</h2>
                                    <a target="_blank" href="{{ asset('images/lurah/'. $verif->foto) }}" data-sub-html="{{$verif->nama}}">
                                <img class="img-responsive thumbnail" width="50%" src="{{ asset('images/lurah/'. $verif->foto) }}">
                                 </a>
                                 </center>                              
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <h2 class="card-inside-title">Tujuan Kelurahan Calon</h2>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" readonly="" name="skck" class="form-control" value="Kelurahan {{$verif->Kelurahan->nama}}">
                                        </div>
                                    </div> 
                                </div>
                                <div class=" col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <a href="{{ asset('storage/'. $verif->akta) }}" target="_blank">
                                            <input type="text" readonly="" name="skck" class="form-control" value="{{$verif->akta}}">
                                            </a>
                                        </div>
                                    </div> 
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="demo-radio-button">
                                        <h2 class="card-inside-title">Verifikasi Data Calon Lurah, Apakah Calon {{$verif->nama}} Telah Memenuhi Syarat?</h2>
...
@push('js')
    <script>
        $("[name='status']").change(function () {
            if($(this).val()=='ya'){
                $("#pesan").val("Data Calon Lurah Lengkap").attr('readonly', 'true')
            } else {
