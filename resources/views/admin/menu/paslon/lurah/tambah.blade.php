                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form role="form" method="post" action="{{ route('add_lurah') }}" enctype="multipart/form-data">
                            	@csrf
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="nama" value="{{old('nama')}}" required="" autocomplete="off" class="form-control" placeholder="Nama Calon Lurah" />
                                        </div>
                                    </div>
                                </div> 
                                <div class="col-sm-12">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6" style="margin-top: 10px">
                                    <h2 class="card-inside-title">Scan Surat Keterangan Catatan Kepolisian</h2>
                                    <div class="form-group">
                                        <div class="form-line">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    ...
                                    <select id="tujuan" name="tujuan" required="" class="form-control">
                                        ...
                                        @foreach ($data as $p)
                                            <option value="{{$p->id}}">Kelurahan {{$p->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-6" style="margin-top: 5px">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="file" value="{{old('akta')}}" name="akta" required="" placeholder="File Bukti">
                                        </div>
                                        <div class="help-info">
                                            File harus berextensi PDF
                                            <p>Ukuran File Maximal : 750KB</p>
